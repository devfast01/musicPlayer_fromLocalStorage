...
import com.example.spotifyclone_example.PlayerActivity.Companion.fabPlayPausePA
...
import com.example.spotifyclone_example.models.getImgArt
...
class MusicService : Service(), AudioManager.OnAudioFocusChangeListener {
    ...
    fun showNotification(playPauseBtn: Int) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            ServiceCompat.startForeground(this,15, notification, ServiceInfo.FOREGROUND_SERVICE_TYPE_MEDIA_PLAYBACK)
        }
